...
const Player = () => {
  ...
  // Auto-restart functionality for Bitchute, Odysee and other iframe videos
  React.useEffect(() => {
    if (videoUrl && (videoUrl.includes('bitchute.com') || videoUrl.includes('odysee.com') || videoUrl.includes('lbry.tv') || videoUrl.includes('youtube.com') || videoUrl.includes('youtu.be') || videoUrl.includes('vimeo.com'))) {
